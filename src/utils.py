...
# signal = AudioSegment.from_file('C:/Users/1vany/Desktop/audio_features-main/audio_features-main/test/29_0_dn.wav')
# # Пример нормализации
# normalized = normalization(signal, -18.0)
# normalized.export('C:/Users/1vany/Desktop/audio_features-main/audio_features-main/test/29_norm.mp3', format='mp3')
# # Пример аугментации
# augmentation('C:/Users/1vany/Desktop/audio_features-main/audio_features-main/test/', '29_0.wav')
#
# # Пример удаления шума
# data, rate = librosa.load('C:/Users/1vany/Desktop/audio_features-main/audio_features-main/test/111.mp3')
# reduced_noise = nr.reduce_noise(y=data, sr=rate)
# sf.write('C:/Users/1vany/Desktop/audio_features-main/audio_features-main/test/111_dn.wav', reduced_noise, rate)
